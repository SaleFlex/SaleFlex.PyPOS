...
def _insert_form_controls(session: Session, cashier_id: str):
    ...
    sale_form_controls = [
        FormControl(
            ...
            fk_parent_id=None,
            name="SALESLIST",
            form_control_function1="SALE_OPTION",
            form_control_function2=None,
            type_no=4,
            type="SALESLIST",
            width=755,
        ...
        FormControl(
            ...
            fk_parent_id=None,
            name="NUMPAD",
            form_control_function1="SALE_PLU_BARCODE",
            form_control_function2=None,
            type_no=5,
            type="NUMPAD",
            width=230,
        ...
        FormControl(
            ...
            fk_parent_id=None,
            name="CLOSURE",
            form_control_function1="CLOSURE",
            form_control_function2=None,
            type_no=1,
            type="BUTTON",
            width=125,
        ...
        FormControl(
            ...
            fk_parent_id=None,
            name="EXIT",
            form_control_function1="EXIT_APPLICATION",
            form_control_function2=None,
            type_no=1,
            type="BUTTON",
            width=125,
    ...
    department_buttons = [
        FormControl(
            ...
            fk_parent_id=None,
            name="DEPARTMENT1",
            form_control_function1="SALE_DEPARTMENT",
            form_control_function2=None,
            type_no=1,
            type="BUTTON",
            width=125,
    ...
    plu_buttons = [
        FormControl(
            ...
            fk_parent_id=None,
            name="PLU1",
            form_control_function1="SALE_PLU_CODE",
            form_control_function2=None,
            type_no=1,
            type="BUTTON",
            width=125,
    ...
    cash_payment_buttons = [
        FormControl(
            ...
            fk_parent_id=None,
            name="CASH2000",
            form_control_function1="CASH_PAYMENT",
            form_control_function2=None,
            type_no=1,
            type="BUTTON",
            width=144,
        ...
        FormControl(
            ...
            fk_parent_id=None,
            name="PAYMENT_CREDIT",
            form_control_function1="CREDIT_PAYMENT",
            form_control_function2=None,
            type_no=1,
            type="BUTTON",
            width=150,
