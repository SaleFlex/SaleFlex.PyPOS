...
| **[Loyalty Programs](docs/41-loyalty-programs.md)** | Earn + redeem (BONUS), policy models, `EARNED`/`REDEEMED`, payment-type earn filter in `settings_json` |
