...
- **Service Layer Architecture**: Centralized business logic services (VatService, SaleService, PaymentService, LoyaltyEarnService, LoyaltyRedemptionService, LoyaltyService, CustomerSegmentService)
...
| **SETTING** | Tabbed configuration: POS / hardware (`PosSettings`) and local **loyalty** program & policies — see [Configuration](04-configuration.md) |
