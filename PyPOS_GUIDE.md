...
**Campaigns (snapshot, SALE sync, limits, `CampaignUsage` audit, coupons, `apply_campaign`):** [Campaign & Promotions](docs/43-campaign-promotions.md)
