...
**Campaigns (snapshot, SALE sync, coupons, `CampaignService`, `CAMPAIGN` type, `apply_campaign`):** [Campaign & Promotions](docs/43-campaign-promotions.md)
