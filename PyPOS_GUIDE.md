...
9. [Document Management System](#document-management-system)
10. [Database Models Overview](#database-models-overview)
11. [Database Initialization Functions](#database-initialization-functions)
...
See [Document Management System](#document-management-system) section above for complete details on transaction document lifecycle, pending documents, and restaurant mode support.
