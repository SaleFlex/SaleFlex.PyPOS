...
class EventHandler(GeneralEvent, SaleEvent, PaymentEvent, ConfigurationEvent,
                   ...
                   ClosureEvent, ProductEvent, CustomerEvent, CampaignEvent):
    """
    ...
    def event_distributor(self, event_name):
        ...
        try:
            ...
            event_handler_map = {
                ...
                EventName.POS_SETTINGS_FORM.name: self._pos_settings_form_event,
                EventName.LOYALTY_SETTINGS_FORM.name: self._loyalty_settings_form_event,
                EventName.CLOSURE.name: self._closure_event,
                EventName.CLOSURE_FORM.name: self._closure_form_event,
                EventName.CLOSURE_DETAIL_FORM.name: self._closure_detail_form_event,
                EventName.CLOSURE_RECEIPTS_FORM.name: self._closure_receipts_form_event,
                EventName.CLOSURE_RECEIPT_DETAIL_FORM.name: self._closure_receipt_detail_form_event,
                ...
                EventName.BONUS_PAYMENT.name: self._bonus_payment_event,
                ...
                EventName.CAMPAIGN_LIST_FORM.name: self._campaign_list_form_event,
                EventName.CAMPAIGN_SEARCH.name: self._campaign_search_event,
                EventName.CAMPAIGN_DETAIL.name: self._campaign_detail_event,
                EventName.CAMPAIGN_DETAIL_SAVE.name: self._campaign_detail_save_event,
            }
